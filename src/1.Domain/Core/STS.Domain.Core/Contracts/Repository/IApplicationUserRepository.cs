...
public interface IApplicationUserRepository
{
    ...
    Task<Result<List<ApplicationUser>>> GetAll(CancellationToken cancellationToken);
    Task<Result<ApplicationUser>> GetBy(int id, CancellationToken cancellationToken);
    ...
    Task<Result<double>> GetBalance(int userId, CancellationToken cancellationToken);
    Task<Result<int>> GetUserIdByClientId(int id, CancellationToken cancellationToken);
    Task<Result<int>> GetUserIdByExpertId(int id, CancellationToken cancellationToken);
